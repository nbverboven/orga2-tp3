...
void tss_inicializar_zombie(unsigned int codigo_zombie, unsigned int jugador)
{
	...
	if ( ( jug && proxima_tarea_a_lanzar_B < 8 ) || ( !jug && proxima_tarea_a_lanzar_A < 8 ) )
	{
		...
		if ( !jug )
		{
			...
			tss_zombisA[proxima_tarea_a_lanzar_A].cr3    = PAGE_DIRECTORY_KERNEL;
			tss_zombisA[proxima_tarea_a_lanzar_A].eip    = DIR_CODIGO_TAREA_IDLE;
			tss_zombisA[proxima_tarea_a_lanzar_A].ebp    = PILA_KERNEL;
			tss_zombisA[proxima_tarea_a_lanzar_A].esp    = PILA_KERNEL;
			...
			tss_zombisA[proxima_tarea_a_lanzar_A].fs     = SELECTOR_DATOS_LVL3;
		...
		{
			// Actualizo el comienzo del TSS de la tarea idle en su descriptor de la GDT
			gdt[proxima_tss_libre_B].base_0_15 =    (unsigned int) &tss_zombisA[proxima_tarea_a_lanzar_B] & 0x0000FFFF;
			gdt[proxima_tss_libre_B].base_23_16 = ( (unsigned int) &tss_zombisA[proxima_tarea_a_lanzar_B] & 0x00FF0000 ) >> 16;
			gdt[proxima_tss_libre_B].base_31_24 = ( (unsigned int) &tss_zombisA[proxima_tarea_a_lanzar_B] &	0xFF000000 ) >> 24;

			tss_zombisA[proxima_tarea_a_lanzar_B].cr3    = PAGE_DIRECTORY_KERNEL;
			tss_zombisA[proxima_tarea_a_lanzar_B].eip    = DIR_CODIGO_TAREA_IDLE;
			tss_zombisA[proxima_tarea_a_lanzar_B].ebp    = PILA_KERNEL;
			tss_zombisA[proxima_tarea_a_lanzar_B].esp    = PILA_KERNEL;
			tss_zombisA[proxima_tarea_a_lanzar_B].eflags = 0x00000202;
			tss_zombisA[proxima_tarea_a_lanzar_B].cs     = SELECTOR_CODIGO_LVL3;
			tss_zombisA[proxima_tarea_a_lanzar_B].ds     = SELECTOR_DATOS_LVL3;
			tss_zombisA[proxima_tarea_a_lanzar_B].es     = SELECTOR_DATOS_LVL3;
			tss_zombisA[proxima_tarea_a_lanzar_B].fs     = SELECTOR_DATOS_LVL3;
			tss_zombisA[proxima_tarea_a_lanzar_B].gs     = SELECTOR_DATOS_LVL3;
			tss_zombisA[proxima_tarea_a_lanzar_B].ss     = SELECTOR_DATOS_LVL3;
